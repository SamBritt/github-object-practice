...
// const result = githubData.filter(ghData => ghData.id == 8030403992);
// console.log(result);

// console.log(githubData[].)

  // const filterId = (arr, inputValue) => {
  //   return arr.filter(el => el.indexOf(inputValue) > -1);
  // };

  // const ghId = githubData.filter(function(ghIds){
  //   return ghIds.id == 8030403992;
  // })

  const filterId = function(arr, inputValue){
    return arr.filter(function(ghIds){
      
      if(ghIds.id == inputValue){
        let obj = ghIds.payload.commits[0].message;
        
        return obj;
        // console.log(ghIds.payload.commits[0].message);
      }
    })
  };

    // console.log(filterId(githubData, '8030403992'));

    // console.log(ghId);
    console.log('hey');
    console.log(filterId(githubData, 8030403992));
    let anything = filterId(githubData, 8030403992);
